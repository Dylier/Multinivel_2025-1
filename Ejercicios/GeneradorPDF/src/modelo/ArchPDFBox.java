...
public class ArchPDFBox {
    ...
    public void crear_PDF(ArrayList<Auto> listaAutos) throws IOException {
        Colocar_Destino();
        ...
        try (PDDocument documento = new PDDocument()) {
            ...
            for (Auto autoObj : listaAutos) {
                ...
                flujoContenidoActual.beginText();
                flujoContenidoActual.newLineAtOffset(xActual + 5, posicionY);
                flujoContenidoActual.showText(String.format("%.1f", autoObj.getCilindraje()));
                flujoContenidoActual.endText();
                xActual += anchosColumnas[3];

                flujoContenidoActual.beginText();
                flujoContenidoActual.newLineAtOffset(xActual + 5, posicionY);
                flujoContenidoActual.showText(String.valueOf(autoObj.getCantPass()));
                flujoContenidoActual.endText();
                xActual += anchosColumnas[4];

                flujoContenidoActual.beginText();
                flujoContenidoActual.newLineAtOffset(xActual + 5, posicionY);
                flujoContenidoActual.showText(String.format("$%,.2f", autoObj.impuesto()));
                flujoContenidoActual.endText();
